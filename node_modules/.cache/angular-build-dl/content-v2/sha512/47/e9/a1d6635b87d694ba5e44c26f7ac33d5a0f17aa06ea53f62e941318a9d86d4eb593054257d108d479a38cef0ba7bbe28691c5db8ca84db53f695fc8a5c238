...
/* harmony import */ var _ionic_native_health_kit_ngx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic-native/health-kit/ngx */ 13188);
...
let AppComponent = class AppComponent {
    constructor(healthKit, platform, zone) {
        ...
        platform.ready().then(() => {
            this.platform.resume.subscribe(() => (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
                this.test();
            }));
        });
    }
    ...
    getheartData() {
        ...
        this.healthKit.querySampleType(heartRateOptions).then((data) => {
            this.zone.run(() => {
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        ...
        providers: [
            ...
            _ionic_native_health_kit_ngx__WEBPACK_IMPORTED_MODULE_2__.HealthKit,
